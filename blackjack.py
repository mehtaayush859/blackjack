...
def deal_card():
  """Returns a random choice card from the deck. """
  cards = [11, 2, 3, 4, 5, 6, 7, 8, 9, 10, 10, 10, 10]
  card = random.choice(cards)
  return card

def caluculate_score(cards):
  """This returns the sum of cards i.e scores"""
...
def compare(user_score, computer_score):
  """This Compares the score between dealer and user and return result of whoever wins.."""
  if user_score == computer_score:
    return "Draw Hard luck 🙃"
  elif computer_score == 0:
    return "Dealer Wins..! 😱"
  elif user_score == 0:
    return "You win with blackjack..!! 😎"
  elif user_score > 21:
    return "You Lose Next time..!! 😭"
  elif computer_score > 21:
    return "You win..Great comeback..!! 😁"
  elif user_score > computer_score:
    return "You win..Kakdak 😃"
  else:
    return "You lose..Kya kare naseeb hi gandu hai..😤"


def play_game():
  """Main game function which had code..!!"""
  print(blackjack)
  user_cards = []
  computer_cards = []
  is_game_over = False
  ...
  print(f"Dealer's final hand is : {computer_cards} and total score is : {computer_score}")
